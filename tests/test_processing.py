...
def _quarterly(current_field="9.99", hours=range(24)):
    ...
    return {
        "DataPoints": {"List": [{"Label": str(h), "Value": str(h / 10)} for h in hours]},
...
def test_process_forecast_maps_fields():
    result = _process_forecast(
        {
            "Forecast_Window": {"Start_time": "2026-06-24T12:00:00", "Duration_hours": "6"},
            "Cheapest_Window": {"Start_time": "2026-06-24T14:00:00", "Duration_hours": "2"},
